...
// TODO: Ignore snippets (such as _troubleshooting.md)

const fs = require('fs');
const path = require('path');
const matter = require('gray-matter'); // Use gray-matter to parse front matter

// Define paths relative to the Docusaurus project root
const projectRoot = path.join(__dirname, '..', '..');
const docsRoot = path.join(projectRoot, 'docs'); // Adjust if your docs folder is in a different location
const activeLinksPath = path.join(projectRoot, 'active_links.json');
const sidebarFilePath = path.join(projectRoot, 'sidebars.js'); // Adjust if your sidebar file is in a different location
